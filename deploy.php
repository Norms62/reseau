...
localServer('localhost')
    ->stage('prod')
    ->env('deploy_path', '/web/vhosts/ticketting.reseau-entreprendre.org');

/* On utilise Git pour récupérer le projet : on indique l'URL du dépôt du projet */
set('repository', 'git+ssh://ticketting.reseau-entreprendre.org/ticketting.reseau-entreprendre.org.git');
